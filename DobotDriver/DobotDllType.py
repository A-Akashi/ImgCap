...
def load():
    if platform.system() == "Windows":
        ...
        return CDLL("DobotDriver/DobotDll.dll",  RTLD_GLOBAL)
    elif platform.system() == "Darwin":
        return CDLL("DobotDriver/libDobotDll.dylib",  RTLD_GLOBAL)
    elif platform.system() == "Linux":
        return cdll.loadLibrary("DobotDriver/libDobotDll.so")
